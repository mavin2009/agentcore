...
- [`./operations/validation.md`](./operations/validation.md): full validation, smoke, persistent-session benchmark commands, and replay invariants
...
- Benchmarks: [`../agentcore/benchmarks/runtime_benchmark.cpp`](../agentcore/benchmarks/runtime_benchmark.cpp), [`../agentcore/benchmarks/persistent_subgraph_session_benchmark.cpp`](../agentcore/benchmarks/persistent_subgraph_session_benchmark.cpp), and [`../python/benchmarks/state_graph_api_benchmark.py`](../python/benchmarks/state_graph_api_benchmark.py)
